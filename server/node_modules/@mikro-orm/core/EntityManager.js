...
class EntityManager {
    ...
    shouldRefresh(meta, entity, options) {
        ...
        let autoRefresh;
        if (options.fields) {
            autoRefresh = options.fields.some(field => !entity.__helper.__loadedProperties.has(field));
        }
        else {
        ...
        if (Array.isArray(options.populate)) {
            return options.populate.some(field => !entity.__helper.__loadedProperties.has(field));
        }
