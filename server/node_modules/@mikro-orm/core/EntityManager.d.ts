...
import type { CountOptions, DeleteOptions, EntityManagerType, FindOneOptions, FindOneOrFailOptions, FindOptions, IDatabaseDriver, LockOptions, NativeInsertUpdateOptions, UpdateOptions, GetReferenceOptions } from './drivers';
...
export declare class EntityManager<D extends IDatabaseDriver = IDatabaseDriver> {
     ...
     */
    nativeInsert<T extends AnyEntity<T>>(entityNameOrEntity: EntityName<T> | T, data?: EntityData<T> | T, options?: NativeInsertUpdateOptions<T>): Promise<Primary<T>>;
    /**
